...
public class DoDien_Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_dodien);
...
//				Toast.makeText(getApplicationContext(), "Title: " + title  + ", Content: " + noidung, Toast.LENGTH_SHORT).show();
	...
	class loaddb extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			DatabaseHelper myDbHelper = new DatabaseHelper(DoDien_Activity.this);
			myDbHelper.createDatabase();
			myDbHelper.openDataBase();
			c = myDbHelper.query("TableMeoVat", null, "Loai=?",  new String[] {"Đồ điện gia dụng"}, null, null,null);
			if (c.moveToFirst()) {
				do {
		...
		protected void onPostExecute(String result) {
			...
			pDialog.dismiss();
			final MeoVatAdapter adapter = new MeoVatAdapter(DoDien_Activity.this);
...
//			});
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(DoDien_Activity.this);
