...
public class VatCanh_Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_vatcanh);
...
//				Toast.makeText(getApplicationContext(), "Title: " + title  + ", Content: " + noidung, Toast.LENGTH_SHORT).show();
	...
	class loaddb extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			DatabaseHelper myDbHelper = new DatabaseHelper(VatCanh_Activity.this);
			myDbHelper.createDatabase();
			myDbHelper.openDataBase();
			c = myDbHelper.query("TableMeoVat", null, "Loai=?",  new String[] {"Chăm sóc hoa, chim cảnh và cá cảnh"}, null, null,null);
			if (c.moveToFirst()) {
				do {
		...
		protected void onPostExecute(String result) {
			...
			pDialog.dismiss();
			final MeoVatAdapter adapter = new MeoVatAdapter(VatCanh_Activity.this);
...
//			});
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(VatCanh_Activity.this);
