...
public class SucKhoe_Activity extends Activity {
...
//				Toast.makeText(getApplicationContext(), "Title: " + title  + ", Content: " + noidung, Toast.LENGTH_SHORT).show();
	...
	class loaddb extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			DatabaseHelper myDbHelper = new DatabaseHelper(SucKhoe_Activity.this);
			myDbHelper.createDatabase();
			myDbHelper.openDataBase();
			c = myDbHelper.query("TableMeoVat", null, "Loai=?",  new String[] {"Các phương pháp chữa bệnh thông thường"}, null, null,null);
			if (c.moveToFirst()) {
				do {
		...
		protected void onPostExecute(String result) {
			...
			pDialog.dismiss();
			final MeoVatAdapter adapter = new MeoVatAdapter(SucKhoe_Activity.this);
...
//			});
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(SucKhoe_Activity.this);
