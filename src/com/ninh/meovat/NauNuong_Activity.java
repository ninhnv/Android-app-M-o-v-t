...
public class NauNuong_Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_naunuong);
...
//				Toast.makeText(getApplicationContext(), "Title: " + title  + ", Content: " + noidung, Toast.LENGTH_SHORT).show();
	...
	class loaddb extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			DatabaseHelper myDbHelper = new DatabaseHelper(NauNuong_Activity.this);
			myDbHelper.createDatabase();
			myDbHelper.openDataBase();
			c = myDbHelper.query("TableMeoVat", null, "Loai=?",  new String[] {"Nấu nướng"}, null, null,null);
			if (c.moveToFirst()) {
				do {
		...
		protected void onPostExecute(String result) {
			...
			pDialog.dismiss();
			final MeoVatAdapter adapter = new MeoVatAdapter(NauNuong_Activity.this);
...
//			});
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(NauNuong_Activity.this);
