...
public class thoitrang_Activity extends Activity {
...
//				Toast.makeText(getApplicationContext(), "Title: " + title  + ", Content: " + noidung, Toast.LENGTH_SHORT).show();
	...
	class loaddb extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			DatabaseHelper myDbHelper = new DatabaseHelper(thoitrang_Activity.this);
			myDbHelper.createDatabase();
			myDbHelper.openDataBase();
			c = myDbHelper.query("TableMeoVat", null, "Loai=?",  new String[] {"Quần áo, giày dép, tất và đồ trang sức"}, null, null,null);
			if (c.moveToFirst()) {
				do {
		...
		protected void onPostExecute(String result) {
			...
			pDialog.dismiss();
			final MeoVatAdapter adapter = new MeoVatAdapter(thoitrang_Activity.this);
...
//			});
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			pDialog = new ProgressDialog(thoitrang_Activity.this);
